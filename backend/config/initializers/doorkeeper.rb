...
Doorkeeper.configure do
  ...
  # This tells Doorkeeper how to authenticate a resource owner (user)
  resource_owner_authenticator do
    current_user || warden.authenticate!(scope: :user)
  end

  # Enable issuing refresh tokens (used to renew expired access tokens)
  use_refresh_token
  ...
  # Skip authorization screen (useful for SPA or API-only apps)
