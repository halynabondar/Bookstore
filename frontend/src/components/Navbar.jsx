          ...
          {user ? (
            ...
            >
              <button
                ...
                className="flex items-center gap-2 rounded-md px-3 py-1 transition hover:bg-primary-dark/10"
              >
              ...
              {userMenuOpen && (
                <div className="absolute right-0 mt-2 w-40 rounded-md bg-dark-200 shadow-lg ring-1 ring-black/10">
                  <button
                    onClick={() => navigate('/profile')}
