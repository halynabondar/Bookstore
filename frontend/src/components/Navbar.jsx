        ...
        <nav className="fixed inset-x-0 top-0 z-50 bg-dark-100 text-primary-dark shadow-md">
            ...
            <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:h-20 sm:px-6">
                ...
                <div className="hidden items-center gap-10 md:inline-flex">
                    ...
                    {/* login */}
                    <div>
                        <button type='button' className='border border-primary-dark hover:bg-primary-light hover:border-primary-light hover:text-dark-100 transition duration-300 bg-dark-100 rounded-md px-4 py-1'>Sign in</button>
                    </div>
                </div>
