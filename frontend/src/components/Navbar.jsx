  ...
  return (
    <nav className="fixed inset-x-0 top-0 z-50 bg-dark-100 text-primary-dark shadow-md">
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:h-20 sm:px-6">
        ...
        <button
          type="button"
          className="hidden rounded-md px-4 py-2 leading-none hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/80 md:inline-flex"
        >
          Cart
        </button>
