  ...
  return (
    <footer className="bg-dark-100 text-primary-dark">
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:p-10">
        <div className="flex justify-around gap-14 md:flex-row flex-col">
          <div className="w-full md:w-1/2 space-y-8">
            ...
            <button type="button" className="flex gap-2 rounded-2xl bg-primary-dark px-3 py-2 text-textc-onDark transition duration-300 hover:bg-primary-light">
              Contact us
              <ArrowForwardIcon />
            </button>
          </div>
          <div className="flex gap-14 flex-row md:justify-between">
            <div className='w-full md:w-1/2 space-y-8'>
