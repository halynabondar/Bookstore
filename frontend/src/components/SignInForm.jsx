        ...
        <div className="flex min-w-full flex-col items-center justify-center gap-4 rounded-2xl bg-dark-100 p-6 shadow-xl sm:min-w-[430px]">
          ...
          <form onSubmit={handleSubmit} className="flex w-full flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                ...
                <input
                    ...
                    className="w-full rounded-md border border-gray-300 py-2 pl-10 pr-10 focus:outline-none focus:ring-primary-light"
                    required
                />
              </div>
            </div>
            ...
            <button
                ...
                aria-label="Sign in"
                disabled={isLoading}
                className="w-full rounded-md bg-primary-dark py-2 text-dark-100 transition duration-300 hover:bg-primary-light disabled:cursor-not-allowed disabled:opacity-70"
            >
