        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            <input
              ...
              className="w-64 rounded-lg border border-gray-200 bg-white px-4 py-2.5 pr-10 text-sm text-primary-dark outline-none transition placeholder:text-gray-400 hover:border-primary focus:border-primary"
            />
