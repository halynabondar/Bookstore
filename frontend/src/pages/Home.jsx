        ...
        <section className="relative h-screen w-full">
            ...
            <div className="absolute inset-0 flex items-center justify-start bg-black/40">
                <div className="ml-12 flex max-w-xl flex-col gap-y-6 px-8 text-left">
                    ...
                    <button onClick={() => navigate("/books")} className="mt-4 flex items-center gap-2 self-start rounded-2xl bg-primary-dark px-6 py-2 text-white transition duration-300 hover:bg-primary-light">
